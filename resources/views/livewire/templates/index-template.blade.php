<div>
    <header class="bg-white dark:bg-gray-800 shadow">
        <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
            <div class="w-full flex justify-between">
                ...
                <x-green-button wire:click="open()">
                    Add New
                </x-green-button>
            </div>
        </div>
    ...
    {{-- <div class="relative z-10 hidden" wire:loading.class.remove="hidden" wire:target="open" aria-labelledby="modal-title" role="dialog" aria-modal="true">
        <!--
          ...
          Leaving: "ease-in duration-200"
            ...
            To: "opacity-0"
        -->
        <div class="fixed inset-0 bg-slate-700 bg-opacity-75 transition-opacity duration-300"></div>

        <div class="fixed top-0 left-0 right-0 z-10 w-screen overflow-y-auto">
