    ...
    <div x-data="{
        ...
        <section x-cloak x-show="banner_section.open" class="w-screen h-screen max-h-screen bg-center bg-no-repeat bg-gray-700 bg-blend-multiply" style="background-image: url({{ asset('image-2.jpg') }})">
            <div class="absolute top-5 right-5">
                <button x-on:click="$dispatch('open-modal', 'edit-invitation')" class="inline-flex justify-center hover:text-gray-900 items-center py-1.5 px-2 text-base font-medium text-center text-white rounded-lg border border-white hover:bg-gray-100 focus:ring-4 focus:ring-gray-400">
            ...
            <div class="px-4 mx-auto max-w-screen-xl text-center py-24 lg:py-56">
                <div contenteditable="true" class="font-{{ $invitation->section->data["customize"]["cover_title_font_style"] != null ? $invitation->section->data["customize"]["cover_title_font_style"] : '' }} dark:{{ $invitation->section->data["customize"]["cover_title_text_color"] != null ? $invitation->section->data["customize"]["cover_title_text_color"] : 'text-white' }} {{ $invitation->section->data["customize"]["cover_title_text_color"] != null ? $invitation->section->data["customize"]["cover_title_text_color"] : 'text-white' }}">
                    <h1 class="  mb-4 text-2xl font-extrabold tracking-tight leading-none md:text-5xl lg:text-5xl ">{{ Str::title($invitation->section->data["cover_section"]["cover_title"]) }}</h1>
                </div>
    ...
    <x-modal name="edit-invitation">
        ...
        <div class="py-4 px-6">
            ...
            <div class="grid md:grid-cols-2 md:gap-6">
              ...
              <div class="relative z-0 w-full mb-6 group">
                  <input type="text" wire:model.live="cover_invitation_date" name="cover_invitation_date" id="floating_last_name" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
